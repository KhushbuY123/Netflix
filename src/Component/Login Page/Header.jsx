...
import { Supported_lan } from '../../utils/constant';
...
function Header() {
  ...
  return (
    <div className="flex justify-between items-center w-full bg-black bg-gradient-to-b from-black  px-4 py-2">
      <img
        className="h-12"
      ...
      <div className="flex items-center">
        ...
        <button className='text-white bg-red-600 p-2 hover:bg-red-800 text-xs rounded-md mx-4' onClick={handlegptSearch}>{showGptSearch?"Home Page":"GPT-Search"}</button>
        <div> 
          <img
            className="h-6 w-6 "
