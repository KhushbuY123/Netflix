...
import useBackVedio from '../../hooks/useBackVedio'

function VedioBack({movieId}) {
  const trailervedio=useSelector(store=>store.movies?.trailervedio)
  useBackVedio(movieId);
  return (
    <div>
        <iframe className='w-screen aspect-video h-[500px]' 
